          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-secondary-700 mb-6 text-lg">
                Chez <b>BEMBELLY & ASSOCIES</b>, nous allions expertise juridique et approche client. Notre équipe d'avocats expérimentés s'engage à vous proposer des solutions pratiques et adaptées à vos besoins spécifiques.
              </p>
